...
Read the [alignment reference](../alignment/README.md) for the complete
simulation-to-report model and accumulated evidence.
...
The repository's `docs/alignment/live-report.md` records source revision, run IDs,
