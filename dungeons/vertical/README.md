...
which funnel-instance the hook touched. Affected dungeons (6):
logistics, real-estate, marketplace,
...
ai-platform, dating, community, and travel graduated off this list in
v1.6: their H9 stories assert the TTC delta itself through `emulateBreakdown`'s
