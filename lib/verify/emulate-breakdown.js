...
import { coerceToBreakdownKey, breakdownSegmentKey } from './coerce.js';
import {
 ...
 * @property {'frequencyByFrequency'|'funnelFrequency'|'aggregatePerUser'|'timeToConvert'|'attributedBy'|'sessionMetrics'|'retention'|'distinctCount'|'eventBreakdown'} type
 *
...
function eventBreakdown(events, { event, breakdownProperty, topN = 250, countType, identityMap }) {
