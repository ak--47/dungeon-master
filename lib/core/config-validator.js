...
export function validateDungeonConfig(config) {
	...
	if (config.bornRecentBias === undefined) config.bornRecentBias = macroResolved.bornRecentBias;
	if (config.percentUsersBornInDataset === undefined) config.percentUsersBornInDataset = macroResolved.percentUsersBornInDataset;
	if (config.preExistingSpread === undefined) config.preExistingSpread = macroResolved.preExistingSpread;
	...
	const validatedConfig = {
		...
		// Macro trend
		macro: config.macro,
		bornRecentBias: config.bornRecentBias,
		percentUsersBornInDataset: config.percentUsersBornInDataset,
		preExistingSpread: config.preExistingSpread,
		// Advanced features
		personas,
		worldEvents,
		engagementDecay,
