...
export function validateDungeonConfig(config) {
	...
	const userBornExplicit = config.percentUsersBornInDataset !== undefined && config.percentUsersBornInDataset !== null;
	const userBiasExplicit = config.bornRecentBias !== undefined && config.bornRecentBias !== null;
