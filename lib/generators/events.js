...
export async function makeEvent(
    ...
    // ── Phase 2: Event-level features (applied before hooks, so hooks can override) ──
    const { userLocation, persona, worldEventsTimeline, resolvedFeatures, resolvedAnomalies, dataQuality: dq, geo: geoConfig, userCampaign } = phase2;
    ...
    // Perf 1: Compute eventUnix once for all Phase 2 time-based checks
