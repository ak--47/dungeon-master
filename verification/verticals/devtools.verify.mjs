...
// HOOK 8: enterprise funnel lift
{
	...
	// post-1.5.0: greedy funnel evaluator + tighter conversion window compresses
	// tier-lift; direction preserved (enterprise > free) — STRONG threshold.
	check('H8 enterprise 1.15x+ funnel vs free', lift >= 1.15,
