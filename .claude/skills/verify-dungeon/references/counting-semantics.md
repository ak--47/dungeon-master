...
When writing per-dungeon verify scripts, follow the template in HOOKS.md §9.9. Reference proofs for all 20 vertical dungeons live at `dungeons/vertical/<name>/` — consult them as exemplars before authoring a new one.
